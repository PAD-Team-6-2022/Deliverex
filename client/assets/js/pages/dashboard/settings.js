...
document
    ...
    .addEventListener('click', async (req, res) => {
        ...
        const values = {
            ...
            acountOldPassword: document.getElementById('acount-old-password')
                .value,
            acountNewPassword: document.getElementById('acount-new-password')
                .value,
            acountConfirmNewPassword: document.getElementById(
                'acount-confirm-new-password',
            ).value,
        };
...
document
    ...
    .addEventListener('click', async (event) => {
        ...
        const values = {
            ...
            streethouseNumber: document.getElementById('Street_house_number')
                .value,
