...
//Helper function. Uses an insanely long regex to check whether the user is on mobile or desktop.
...
if(isOnMobile()){
    ...
    document.querySelector("#invalid-device-message").classList.add("hidden");
